...
statements = [
    ...
    "I don't feel good or bad today",
...
file_path = r'D:\MS Ai900\data-trained1.csv'  # Use raw string to handle backslashes in Windows file paths
...
# Display the original DataFrame with Sentiment values
